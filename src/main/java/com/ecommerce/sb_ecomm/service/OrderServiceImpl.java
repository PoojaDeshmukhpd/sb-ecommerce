...
import com.ecommerce.sb_ecomm.model.*;
import com.ecommerce.sb_ecomm.payload.OrderDTO;
import com.ecommerce.sb_ecomm.payload.OrderItemDTO;
import com.ecommerce.sb_ecomm.repository.*;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDTO placeOrder(String emailId, Long addressId, String paymentMethod, String pgName, String pgPaymentId, String pgStatus, String pgResponseMessage) {
        ...
        if (cart == null) {
            throw new ResourceNotFoundException("cart ", "email ", emailId, addressId);
        }
